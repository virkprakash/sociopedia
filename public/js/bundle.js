...
var showAlert = function showAlert(type, message) {
  hideAlert();
  var alertBox = "<div class=\"alert alert--".concat(type, "\">").concat(message, "</div>");
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            console.log(res.data); // if successful status == success

            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in successfully, WELCOME!'); //reload after 1.5 second 
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('error', 'Logout Successful, Please Log in');
              window.setTimeout(function () {
                location.assign('/login');
              }, 1500);
            }
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Signup Successful, Please Log in'); //reload after 1.5 second  and redirect to login Page
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', "signup unsuccessful ".concat(message)); // stay on the same page 
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"campaign.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addCampaign = exports.suspendCampaign = exports.declineCampaign = exports.approveCampaign = void 0;
...
var approveCampaign = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3030/api/campaign/".concat(id),
              data: {
                approved: true
              }
            });
          ...
          case 3:
            ...
            if (response.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Campaign approved');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'something went wrong, Try again');
            window.setTimeout(function () {
              location.assign('/');
            }, 1);
  ...
  return function approveCampaign(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var declineCampaign = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            // if successful 
            if (response.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Campaign Deleted');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
  ...
  return function declineCampaign(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.declineCampaign = declineCampaign;

var suspendCampaign = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            // if successful 
            if (response.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Campaign suspended');
              window.setTimeout(function () {
                location.assign('/');
              }, 1);
            }
  ...
  return function suspendCampaign(_x3) {
    return _ref3.apply(this, arguments);
  };
}(); // Adds campaign Data
...
var addCampaign = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(name, description, address, date) {
    var response;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            // if successful 
            if (response.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Campaign added, Please allow admin to approve!!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Please Fill up the Form correctly');
            window.setTimeout(function () {
  ...
  return function addCampaign(_x4, _x5, _x6, _x7) {
...
// makes es6 feature compatible 
// DOM ELEMENT 
var loginForm = document.querySelector('.form');
var logoutBtn = document.querySelector('.nav__el--logout');
var signupForm = document.querySelector('.form--signup');
var addButton = document.querySelector('.btn-add');
var approveButtons = document.getElementsByClassName("btn-approve");
var declineButtons = document.getElementsByClassName("btn-decline");
var suspendButtons = document.getElementsByClassName("btn-suspend"); // add event listener to approveButtons

if (approveButtons) {
  for (var i = 0; i < approveButtons.length; i++) {
    approveButtons[i].addEventListener('click', function (e) {
      e.preventDefault();
      (0, _campaign.approveCampaign)(this.dataset.id);
    });
  }
...
if (declineButtons) {
  for (var i = 0; i < declineButtons.length; i++) {
    declineButtons[i].addEventListener('click', function (e) {
      e.preventDefault();
      (0, _campaign.declineCampaign)(this.dataset.id);
    });
  }
...
if (suspendButtons) {
  for (var i = 0; i < suspendButtons.length; i++) {
    suspendButtons[i].addEventListener('click', function (e) {
      e.preventDefault();
      (0, _campaign.suspendCampaign)(this.dataset.id);
    });
  }
...
if (addButton) {
  addButton.addEventListener('click', function (e) {
    ...
    (0, _campaign.addCampaign)(name, description, address, date);
  });
...
if (logoutBtn) logoutBtn.addEventListener('click', _login.logout); // add event listener to signup button 
